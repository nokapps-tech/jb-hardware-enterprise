<section class="w-full">
    <div class="mb-6">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item href="{{ route('storage2-transactions.show', $storage2Transaction->id) }}">{{ $storage2Transaction->name }}</flux:breadcrumbs.item>
    ...
    <div class="flex flex-col xl:justify-between xl:flex-row my-6">
        <div class="mb-6">
            <flux:heading size="xl" level="1">Edit {{ $storage2Transaction->name }}</flux:heading>
            <flux:subheading size="lg">Update the information for this storage B Transaction.</flux:subheading>
        </div>

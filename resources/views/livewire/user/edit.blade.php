<section class="w-full">
    <div class="mb-6">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item href="{{ route('users.show', $user->id) }}">{{ $user->name }}</flux:breadcrumbs.item>
    ...
    <div class="flex flex-col xl:justify-between xl:flex-row my-6">
        <div class="mb-6">
            <flux:heading size="xl" level="1">Edit {{ $user->name }}</flux:heading>
            <flux:subheading size="lg">Update the information for this user.</flux:subheading>
        </div>

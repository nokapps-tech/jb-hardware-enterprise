<section class="w-full">
    ...
    {{-- Storage 1 Transactions --}}
<div class="p-4 sm:p-8 border border-zinc-200 dark:border-zinc-700 sm:rounded-lg mt-6">
    <div class="px-4 pb-6 sm:px-0">
        <flux:heading size="lg" level="2">Storage 1 Transactions</flux:heading>
    </div>
    <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
        ...
        <tbody>
            @forelse($storage1Transactions as $index => $transaction)
                <tr>
...
{{-- Storage 2 Transactions --}}
<div class="p-4 sm:p-8 border border-zinc-200 dark:border-zinc-700 sm:rounded-lg mt-6">
    <div class="px-4 pb-6 sm:px-0">
        <flux:heading size="lg" level="2">Storage 2 Transactions</flux:heading>
    </div>
    <table class="min-w-full divide-y divide-zinc-200 dark:divide-zinc-700">
        <thead class="bg-zinc-50 dark:bg-zinc-800">
            <tr>
        ...
        <tbody>
            @forelse($storage2Transactions as $index => $transaction)
                <tr>
                    <td class="px-4 py-2">{{ $index + 1 }}</td>
                    <td class="px-4 py-2">{{ $transaction->created_at->format('M d, Y') }}</td>
                    <td class="px-4 py-2">

<section class="w-full">
    ...
    <div class="flex flex-col xl:justify-between xl:flex-row my-6">
        <div class="mb-6">
            <flux:heading size="xl" level="1">{{ __('Create Branch') }}</flux:heading>
            <flux:subheading size="lg">Add a new branch by filling in the required information.</flux:subheading>
        </div>

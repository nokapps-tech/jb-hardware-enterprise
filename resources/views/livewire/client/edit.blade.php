<section class="w-full">
    <div class="mb-6">
        <flux:breadcrumbs>
            ...
            <flux:breadcrumbs.item href="{{ route('clients.show', $client->id) }}">{{ $client->name }}</flux:breadcrumbs.item>
    ...
    <div class="flex flex-col xl:justify-between xl:flex-row my-6">
        <div class="mb-6">
            <flux:heading size="xl" level="1">Edit {{ $client->name }}</flux:heading>
            <flux:subheading size="lg">Update the information for this client.</flux:subheading>
        </div>
